...
const inventory = new Set(['stock', 'stock-movements', 'stock-transfers', 'breakages', 'reservations', 'inventory-adjustments', 'inventory-adjustment-records', 'inventory-adjustment-lines'])
